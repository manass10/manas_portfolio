    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-12 h-12">
          ...
          />
          <path
            d="M12.5 22.118c-.305-.398-.595-.853-.895-1.308v-.001c-.015-.026-.029-.052-.043-.077-.83-1.154-1.779-2.65-1.779-5.108 0-2.1.61-3.5 1.365-4.8.755-1.3 1.654-2.4 1.654-4.2 0-1.26-.786-2.3-1.654-3.4-.868-.296-.103-1.662-.197-2.218z"
            fill="#47A248"
          />
        </svg>
      ),
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-12 h-12">
          ...
          <path d="M12 5.5L8.5 16h2l.75-2.5h3.5L15.5 16h2L12 9z" fill="white" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-12 h-12">
          ...
          <path
            d="M12 6c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4z"
            fill="white"
          />
          <path
            d="M12 9c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3z"
            fill="#FF6C37"
          />
        </svg>
      ),
